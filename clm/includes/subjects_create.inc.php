...
<?php
if (isset($_SESSION['file_not_allowed'])) {
?>
    <div id="toast-danger" class="mx-auto flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        <div class="ml-3 text-sm font-normal"><?php echo $_SESSION['file_not_allowed']; ?></div>
...
<?php
    unset($_SESSION['file_not_allowed']);
}
?>
...
?>
    <div id="toast-danger" class="mx-auto flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        <div class="ml-3 text-sm font-normal"><?php echo $_SESSION['file_error']; ?></div>
        <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target="#toast-danger" aria-label="Close">
            <span class="sr-only">Close</span>
            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
...
?>
    <div id="toast-danger" class="mx-auto flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        <div class="ml-3 text-sm font-normal"><?php echo $_SESSION['file_size']; ?></div>
        <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target="#toast-danger" aria-label="Close">
            <span class="sr-only">Close</span>
            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
...
?>
    <div id="toast-danger" class="mx-auto flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        <div class="ml-3 text-sm font-normal"><?php echo $_SESSION['code_exist']; ?></div>
        <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target="#toast-danger" aria-label="Close">
            <span class="sr-only">Close</span>
            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
...
?>
    <div id="toast-success" class="mx-auto flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        <div class="ml-3 text-sm font-normal"><?php echo $_SESSION['success']; ?></div>
...
?>
    <div id="toast-danger" class="mx-auto flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        <div class="ml-3 text-sm font-normal"><?php echo $_SESSION['failed']; ?></div>
        <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target="#toast-danger" aria-label="Close">
            <span class="sr-only">Close</span>
            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
...
<form action="./functions/SubjectCreate.php" method="POST" enctype="multipart/form-data">
    <h2 class="mb-3 text-left text-3xl font-bold tracking-tight text-gray-900">
        Create Subject
    </h2>

    <div class="flex flex-col py-2 text-gray-400">
        <label for="" class="block font-medium text-sm text-gray-700">Subject Code</label>
        <input class="text-gray-700  bg-slate-100 mt-2 p-2
                            ...
                            focus:ring-opacity-50" type="text" name="subject_code" id="subject_code" required>
    </div>

    <div class="flex flex-col py-2 text-gray-400">
        <label for="" class="block font-medium text-sm text-gray-700">Subject Description</label>
        <input class="text-gray-700  bg-slate-100 mt-2 p-2
                            rounded-md focus:outline-blue-200
                            shadow-sm border-gray-300 focus:border-indigo-300
                            focus:ring focus:ring-indigo-200
                            focus:ring-opacity-50" type="text" name="subject_desc" id="subject_desc" required>
    </div>
    ...
    <div class="flex flex-col py-2 text-gray-400">
        <label for="" class="block font-medium text-sm text-gray-700">Subject PDF File</label>
        <input class="text-gray-700  bg-slate-100 mt-2 p-2
                            rounded-md focus:outline-blue-200
                            shadow-sm border-gray-300 focus:border-indigo-300
                            focus:ring focus:ring-indigo-200
                            focus:ring-opacity-50" type="file" name="subject_file" id="subject_file" accept="application/pdf" required>
    </div>
    ...
    <div class="mt-3">
        <button class="w-full  items-center px-4 py-2 bg-gray-800
                        ...
                        ease-in-out duration-150" name="create" id="" type="submit">
            Create
        </button>
    </div>
</form>
...
<div class="mt-3">
    <a href="./app.php?content=subjects">
        <button class="w-full  items-center px-4 py-2
